<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Filter.aspx.cs" Inherits="Activities.Filter" %>
        ...
        <div class="row">
            ...
            <div class="col-lg-12" runat="server" id="div_searchActivityContent">
                <form runat="server" id="form_searchActivities">
                    ...
                    <asp:Button Text="Search" runat="server" CssClass="btn btn-default col-lg-2" ID="button_filter" OnClick="button_filter_Click" />
                </form>
            </div>
            ...
            <asp:Repeater runat="server" ID="repeater_filter">
                <ItemTemplate>
